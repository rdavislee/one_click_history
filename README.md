...
Once you've implemented your concepts, you can run the Concept Server to expose them as REST API endpoints:

```shell
deno task concepts
```

This starts the server on **http://localhost:8000** with all your concepts automatically exposed at `/api/{ConceptName}/{actionName}`.

## API Documentation

Comprehensive API documentation is available in [`design/API-DOCUMENTATION.md`](design/API-DOCUMENTATION.md), including:

- Complete endpoint specifications for each concept
- Request/response formats
- Example workflows and curl commands
- Error handling details

Individual concept API specifications:
