...
content_id: 5eb073aadfabe022e2edfdaf02f7c2657db7010bf48b0c74bb62e84cc21a6521
---
...
Deno.test("UserAuthentication Concept Tests", async (test) => {
  ...
  Deno.test.beforeAll(async () => {
    // Ensure the collection is clean before running tests,
    // though testDb() already handles dropping the database.
    await concept.users.deleteMany({});
  });

  await test.step("Principle: Registration, successful login, and rejection of duplicate registration", async () => {
  ...
  await test.step("Action: register - empty username requirement", async () => {
  ...
  await test.step("Action: register - empty password requirement", async () => {
  ...
  await test.step("Action: register - duplicate username requirement", async () => {
  ...
  await test.step("Action: login - successful login", async () => {
  ...
  await test.step("Action: login - non-existent username", async () => {
  ...
  await test.step("Action: login - incorrect password", async () => {
  ...
  await test.step("Action: changePassword - user not found requirement", async () => {
  ...
  await test.step("Action: changePassword - incorrect old password requirement", async () => {
  ...
  await test.step("Action: changePassword - empty new password requirement", async () => {
